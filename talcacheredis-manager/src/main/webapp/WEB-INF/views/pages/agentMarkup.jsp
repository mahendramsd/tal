...
<div class="wrapper">
    <div class="row">
        <div class="col-md-12">
            <header>
                <h3>Update Agent Markup To The Postgresql Database From
                    PICK Database.</h3>
            </header>
            <hr>
            <c:if test="${isProcess}">
                <div id="div_initial_notify">
                    <h5 class="alert alert-success text-center">Started Main
                        Hotel Automate Process</h5>
            ...
            <table align="center" width="45%" cellspacing="0" cellpadding="5"
                ...
                <tr>
                    ...
                    <td><input type="button"
                               value="Start Agent Markup Automate Process" id="btnStartAgentMarkup"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="button"
                               value="Stop Agent Markup Automate Process" id="btnStopAgentMarkup"/></td>
                </tr>
            </table>
        </div>
...
<script src="${root}/resources/js/agentMarkup.js"></script>
