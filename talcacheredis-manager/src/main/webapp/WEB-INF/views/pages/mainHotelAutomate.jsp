...
<div class="wrapper">
    <div class="row">
        <div class="col-md-12">
            <header>
                <h3>Update New Main Hotels To The Postgresql Database From
                    PICK Database.</h3>
            </header>
            <hr>
            <c:if test="${isProcess}">
            ...
            <table align="center" width="45%" cellspacing="0" cellpadding="5"
                ...
                <tr>
                    ...
                    <td><input type="button"
                               value="Start Main Hotel Automate Process" id="btnStartAutomate"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="button"
                               value="Stop Main Hotel Automate Process" id="btnStopAutomate"/></td>
                </tr>
            </table>
        </div>
...
<script src="${root}/resources/js/mainHotelUpdate.js"></script>
