...
<div class="wrapper">
    <div class="row">
        <div class="col-md-7">
            <header>
                <h3>Download All Availability and Rate Amount Notification</h3>
            </header>
            <!-- <div class="clear">&nbsp;</div> -->
            <hr>
            <!-- <div class="clear">&nbsp;</div> -->
            <form action="${root}/xml/genarateXMLAll" method="POST">
                <div class="clear">&nbsp;</div>
                <div class="row">
                    <div class="col-md-4">Maximum hotels per file</div>
                    <div class="col-md-4"><input type="text" name="count" required="required"/></div>
                ...
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4">
                        <button id="btnSubmit" class="btn btn-success" type="submit">Generate
                            All &nbsp;&nbsp;&nbsp;
                        </button>
                    </div>
                    <div class="col-md-4"></div>
